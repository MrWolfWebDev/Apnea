...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>CLUB APNEA - Corso Base</title>
                ...
                <div class="wrapper clearfix">
                    ...
                    <div class="demo" style="height:60px; background-color: #003380;">
                        ...
                        <div style="color:#EEE; float:right; text-align:right; font-size:10px; font-family:Arial, Helvetica, sans-serif; padding-right:20px; margin-top:-16px;">
                            ...
                            <img id="accademia" src="img/logo_AA_Refl.png"  width="80" alt="apnea accademy" /></div>
                ...
                <div class="wrapper">
                    ...
                    <div class="project-slider" style= "margin-bottom:-30px;">
                        <div class="flexslider">
                            <ul class="slides">
                                <li>
                                    <img src="img/corsi/base/01.jpg" alt="corsi apnea" />
                                </li>
                ...
                <div class="demo2" style="height:100%; margin-top:-60px;
                    ...
                    <div class="project-heading">
                        ...
                        <div class="portfolio-thumbs clearfix" >
                            ...
                            <!-- area testo ----------------------------------------------------------- --><span style="width:28%; height:100%; float:right; padding-right: 20px; margin-bottom:20px;"><img id="fotoa" src="img/corsi/base/02.jpg" width="100%" alt="foto"/></span>
                            ...
                            <div id="corsitesto">
                                ...
                                <p style="font-family:Arial, Helvetica, sans-serif"><span style="color:#39F; font-weight: bold;">DOVE:</span><br>
                                    ...
                                    Il corso base è studiato per chi si avvicina al mondo dell’immersione in apnea: si propone di far riscoprire il naturale gesto dell’apnea ed il benessere nell’ambiente acquatico e prevede una parte in piscina e una in acque libere. La parte in piscina consta di <span class="bold">12 incontri per un totale di 30 ore di lezione </span>(teoria e pratica) tra cui: acquaticità, esercizi a corpo libero, <span class="bold">tecniche di respirazione (pranayama)</span> e di rilassamento (training autogeno, training mentale ecc.), apnea statica e dinamica. la parte in mare, prevede 4 uscite per tuffarsi nel blu in assetto costante.<br> Il corso comprende il manuale “Corso di apnea” di Umberto Pelizzari e Stefano Tovaglieri e il brevetto di livello base di Apnea Academy.<br><br>


                                    <span style="color:#39F; font-weight: bold;">REQUISITI:</span><br>
                                    Per iscriversi è necessario <span class="bold">avere 14 anni</span>, saper nuotare sufficientemente a rana e a stile libero. Per la frequenza della parte in piscina è richiesto un certificato di idoneità all’attività subacquea (rilasciabile anche dal medico di base) mentre per quella in mare, a fine corso, occorre un certificato medico di idoneità all’attività sportiva agonistica (rilasciabile da un centro di medicina sportiva; è possibile scaricare l’elenco dei centri di medicina sportiva di Milano dal sito www.clubapnea.org). <span class="bold">Chi lo volesse, quindi, può presentare da subito un solo certificato, quello sportivo agonistico.</span><br><br>


                                    <span style="color:#39F; font-weight: bold;">ATTREZZATURA:</span><br>
                                    Per la parte in acqua maschera, aeratore, pinne, calzari e muta da apnea, cintura con zavorra (le prime 2 lezioni è necessario solo il costume e gli occhialini. Si terrà una spiegazione sull’attrezzatura, per cui si consiglia di attendere tale lezione prima di acquistarla). Per le sedute di respirazione e rilassamento a secco occorre abbigliamento comodo (pantaloni, maglietta, tappetino, fazzoletti di carta). L’attrezzatura non è fornita dall’organizzazione; ogni allievo dovrà avere la propria.
                                    <br><br>


                                    <span style="color:#39F; font-weight: bold;">ACQUE LIBERE:</span><br>
                                    Le uscite in mare, per il conseguimento del <span class="bold">brevetto di livello base di Apnea Academy</span>, saranno comunicate durante il corso. Se l’allievo porta a termine la parte in piscina e non quella in mare, potrà farlo entro 1 anno. Decorso l’anno, dovrà ripetere il corso.<br><br>


                                    <span style="color:#39F; font-weight: bold;">ISCRIZIONE, COSTI:</span><br>
                                    L’intero corso (teoria e pratica in piscina e in acque libere, manuale e brevetto) costa <span class="bold">449 €</span>. Puoi iscriverti on line o contattando la nostra segreteria. <span class="bold">L’iscrizione si completa consegnando alla Segreteria di Clubapnea l’originale del certificato medico, una fototessera e la quota di iscrizione. In nessun caso saranno ammessi  iscritti privi di certificato medico.</span><br><br>
                                </p>
                            ...
                            <div style="width:28%; height:100%; float:right; padding-right: 20px; margin-bottom:20px;">
                                <img id="fotob" src="img/corsi/base/03.jpg" width="100%"alt="foto" />
                            </div>
