...
<html class="no-js">
    ...
    <head>
        <meta charset="utf-8"/>
        <title>CLUB APNEA - Corso Apnea Monopinna</title>
            ...
            <div class="wrapper">
                ...
                <div class="project-slider" style= "margin-bottom:-30px;">
                    <div class="flexslider">
                        <ul class="slides">
                            <li>
                                <img src="img/corsi/monopinna/01.jpg" alt="corsi apnea" />
                            </li>
                ...
                <div class="project-heading">
                    ...
                    <div class="portfolio-thumbs clearfix" >
                        ...
                        <div style="width:28%; height:100%; float:right; padding-right: 20px; margin-bottom:20px;">
                            <img id="fotoa" src="img/corsi/monopinna/02.jpg" width="100%" alt="foto"/>
                        </div>
                        ...
                        <div id="corsitesto">   
                            ...
                            <p style="font-family:Arial, Helvetica, sans-serif"><span style="color:#39F; font-weight: bold;">DOVE:</span><br>
                                Piscina MURAT, via Dino Villani, n. 2 Milano.<br><br>
                        ...
                        <!-- area foto 2 ----------------------------------------------------------- -->
                        <div style="width:28%; height:100%; float:right; padding-right: 20px; margin-bottom:20px;">
                            <img id="fotob" src="img/corsi/monopinna/03.jpg" width="100%"alt="foto" />
                        </div>
