            ...
            <div class="wrapper">
                ...
                <div class="project-slider" style= "margin-bottom:-30px;">
                    <div class="flexslider">
                        <ul class="slides">
                            <li>
                                <img src="img/corsi/eventi/01.jpg" alt="corsi apnea" />
                            </li>
                ...
                <div class="project-heading">
                    ...
                    <div class="portfolio-thumbs clearfix" >
                        ...
                        <div style="width:28%; height:100%; float:right; padding-right: 20px; margin-bottom:20px;">
                            <img id="fotoa" src="img/corsi/eventi/02.jpg" width="100%" alt="foto"/>
                        </div>
                        ...
                        <!-- area foto 2 ----------------------------------------------------------- -->
                        <div style="width:28%; height:100%; float:right; padding-right: 20px; margin-bottom:20px;">
                            <img id="fotob" src="img/corsi/eventi/03.jpg" width="100%"alt="foto" />
                        </div>
